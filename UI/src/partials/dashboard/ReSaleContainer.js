...
import { BASE_URL, RESALE_ROUTE } from "../../utils/APIUrls";
import { getLastDateOfMonth } from "../../utils/Utils";
import NoRecordsFound from "../components/noRecordsFound";
import { axiosInstance } from "../../utils/AxiosInstance";

const ResaleLeadsContainer = props => {
  ...
  const fetchData = async (data, recordLimit, recordOffset) => {
    try {
      const response = await axiosInstance.post(
        `${BASE_URL}${RESALE_ROUTE.getResaleLeads}`,
        {
          limit: recordLimit,
          offset: recordOffset,
          startDate: startDate,
...
export default ResaleLeadsContainer;
